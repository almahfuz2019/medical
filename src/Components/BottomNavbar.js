    ...
    return <Loading/>;
     ...
     return (
          ...
          <div class="w-full mt-16">
                <section id="bottom-navigation" class=" block fixed inset-x-0 bottom-0 z-10 bg-white shadow lg:hidden"> 
               <section id="bottom-navigation" class="block fixed inset-x-0 bottom-0 z-10 bg-white border-t-1 border border-primary shadow border-x-0 border-b-0 border-opacity-30">
                    <div id="tabs" class="flex justify-between items-center pt-2">
                         <Link to="/" class="w-full focus:text-primary hover:text-primary justify-center inline-block text-center  ">
                         ...
                         <Link to="/view-cart" class="w-full focus:text-primary hover:text-primary justify-center inline-block text-center   cursor-pointer">

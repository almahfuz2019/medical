...
const HomePageCatagory = () => {
     return (
          <div>
            <section>
  <div class="max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 bg-gray-100 my-12">
    <div
    ...
    >
      <div class="mx-auto max-w-lg text-center lg:mx-0 lg:text-left">
        <h2 class="text-3xl font-bold sm:text-4xl">Find your products catagory </h2>
        ...
        <Link
          class="mt-8 inline-flex items-center btn btn-primary"
          to="/all-Products"
        >
      ...
      <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 border p-5">
  ...
  <img
    ...
    alt=""
    class="w-full object-cover transition duration-500 group-hover:opacity-90"
  />

  <div class="absolute inset-0 flex flex-col items-start justify-end p-2">
    <h3 class="text-xl font-medium text-white bg-gray-700 p-2 hover:underline ">Baby Care</h3>
  </div>
</a>
  ...
  <div class="absolute inset-0 flex flex-col items-start justify-end p-2">
    <h3 class="text-xl font-medium text-white bg-gray-700 p-2 hover:underline underline-">Baby Care</h3>
  </div>
</a>

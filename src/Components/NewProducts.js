...
import { Link, createBrowserHistory, useNavigate } from 'react-router-dom';
...
const NewProducts = () => {
     ...
     return (
          <>
          <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 mx-5-2 sm:mx-0 bg-white p-2'>

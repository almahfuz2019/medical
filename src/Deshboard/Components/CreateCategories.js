...
const CreateCategories = () => {
     ...
     const catagoryData={catagory};
      await axios.post("https://server.chaayasurgical.com/catagory",catagoryData)
    ...
    <h2 className='font-bold text-xl sm:text-3xl'>Create a Category</h2>
     ...
     <div className="relative mb-4">
        ...
        <input placeholder='Type here' type="text"  name="findClass" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
      </div>
